...
int main()
{
	...
	while (playing == 1)
	{
		...
		if (player == 2)
		{
			cout << "The computer placed their \"o\" in spot " << location << ".\n\tPlayer, enter a number: ";
			while (valid == 0)
			{
				cin >> location;
		...
		valid = 0;
		if (player == 1 && occupied == 0)
			location = "5";
		else if (player == 1 && occupied == 1)
		{
			if (square[3] == "x")
				location = "9";
			else if (square[1] == "x")
		...
		else if (player == 1 && occupied == 2)
		{
			if (square[3] == "x" && square[0] == "x")
				location = "7";
			else if (square[1] == "x" && square[2] == "x")
				location = "1";
			else if (square[5] == "x" && square[8] == "x")
				location = "3";
			else if (square[7] == "x" && square[6] == "x")
				location = "9";
			else if (square[0] == "x")
			{
				if (square[1] == "x" || square[7] == "x")
					location = "3";
				else if (square[5] == "x" || square[3] == "x")
					location = "7";
				else if (square[2] == "x")
					location = "2";
				else if (square[6] == "x")
			...
			{
				if (square[5] == "x" || square[3] == "x")
					location = "9";
				else if (square[7] == "x" || square[1] == "x")
					location = "1";
				else if (square[8] == "x")
					location = "6";
				else if (square[0] == "x")
		...
		else if (player == 1 && occupied == 3)
		{
			if (square[0] == square[1] && square[2] == "3" && square[0] == "o")
				location = "3";
			else if (square[0] == square[2] && square[1] == "2" && square[0] == "o")
				location = "2";
			else if (square[1] == square[2] && square[0] == "1" && square[1] == "o")
				location = "1";
			else if (square[3] == square[4] && square[5] == "6" && square[3] == "o")
				location = "6";
			else if (square[3] == square[5] && square[4] == "5" && square[3] == "o")
				location = "5";
			else if (square[4] == square[5] && square[3] == "4" && square[4] == "o")
				location = "4";
			else if (square[6] == square[7] && square[8] == "9" && square[6] == "o")
				location = "9";
			else if (square[6] == square[8] && square[7] == "8" && square[6] == "o")
				location = "8";
			else if (square[7] == square[8] && square[6] == "7" && square[7] == "o")
				location = "7";
			else if (square[0] == square[3] && square[6] == "7" && square[0] == "o")
				location = "7";
			else if (square[0] == square[6] && square[3] == "4" && square[0] == "o")
				location = "4";
			else if (square[3] == square[6] && square[0] == "1" && square[3] == "o")
				location = "1";
			else if (square[1] == square[4] && square[7] == "8" && square[1] == "o")
				location = "8";
			else if (square[1] == square[7] && square[4] == "5" && square[1] == "o")
				location = "5";
			else if (square[4] == square[7] && square[1] == "2" && square[4] == "o")
				location = "2";
			else if (square[2] == square[5] && square[8] == "9" && square[2] == "o")
				location = "9";
			else if (square[2] == square[8] && square[5] == "6" && square[2] == "o")
				location = "6";
			else if (square[5] == square[8] && square[2] == "3" && square[5] == "o")
				location = "3";
			else if (square[0] == square[4] && square[8] == "9" && square[0] == "o")
				location = "9";
			else if (square[0] == square[8] && square[4] == "5" && square[0] == "o")
				location = "5";
			else if (square[4] == square[8] && square[0] == "1" && square[4] == "o")
				location = "1";
			else if (square[2] == square[4] && square[6] == "7" && square[2] == "o")
				location = "7";
			else if (square[2] == square[6] && square[4] == "5" && square[2] == "o")
				location = "5";
			else if (square[4] == square[6] && square[2] == "3" && square[4] == "o")
				location = "3";
